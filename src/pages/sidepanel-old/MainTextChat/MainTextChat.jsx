...
import { parseAndRenderText } from '../parseAndRenderText/parseAndRenderText';
  ...
  return (
    <div className={styles.mainTextWrapper}>
      <h1 className={styles.mainText}>
        <span style={{ color: '#B9BCB8' }}>
          {!['Any thoughts?', ''].includes(submittedTextState) && submittedTextState.trim().concat(' ')}
        </span>
        {parseAndRenderText(aiState)}
      </h1>
