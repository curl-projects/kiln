import { TLShapeId, TLUnknownShape, getPointerInfo, stopEventPropagation, useEditor, useValue } from '@tldraw/editor';
...
export function useEditableText(id: TLShapeId, type: string, text: string) {
  ...
  const isEditingAnything = useValue('isEditingAnything', () => !!editor.getEditingShapeId(), [editor]);
