...
/** @public */
export class WorldModelShapeTool extends BaseBoxShapeTool {
	static override id = 'worldModel'
	static override initial = 'idle'
	override shapeType = 'worldModel'
	...
	override onCreate = (shape: TLShape | null): void => {
		...
		if (this.editor.getInstanceState().isToolLocked) {
			this.editor.setCurrentTool('worldModel')
		} else {
