...
/** @public */
export class KinematicCanvasShapeTool extends BaseBoxShapeTool {
	static override id = 'kinematicCanvas'
	static override initial = 'idle'
	override shapeType = 'kinematicCanvas'
	...
	override onCreate = (shape: TLShape | null): void => {
		...
		if (this.editor.getInstanceState().isToolLocked) {
			this.editor.setCurrentTool('kinematicCanvas')
		} else {
