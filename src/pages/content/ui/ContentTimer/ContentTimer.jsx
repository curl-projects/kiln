    ...
    return(
        <div className={"timerRow"}>
            ...
            <div className={"playButtonBox"} onClick={()=>{}}>
                {syncState?.isActive 
                ? <p className={"playButton"} style={{ left: "0px"}} onClick={() => triggerExtensionAction('pauseTimer')}><FaPause /></p>
                : <p className={"playButton"} onClick={() => triggerExtensionAction('startTimer')}><FaPlay /></p>
                }
            </div>
        </div>
    );
