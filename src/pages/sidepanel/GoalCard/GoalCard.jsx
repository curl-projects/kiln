...
export default function GoalCard(props){
    ...
    <div 
        ...
        <div className={styles.goalBadgeWrapper}>
            <div className={styles.goalBadgeInnerCircle} style={{
                backgroundColor: isHovered ? "rgba(254, 172, 133, 0.5)" : "#EFF1EF",
            }}/>
            <div className={styles.goalBadgeOuterCircle} style={{
        ...
        <div className={styles.goalTitleWrapper}>
            ...
            <p className={styles.goalTitle} style={{
                color: isHovered ? "rgba(254, 172, 133, 1)" : "#7F847D"
            
            }}>{props.goal.title}</p>
            <div className={styles.goalTitleLine} style={{
   ...
   return(
    <div 
        ...
        <div className={styles.goalTitleWrapper}>
            ...
            }}>Create a new goal on the homepage</p>
            {/* <div className={styles.goalTitleLine} style={{
